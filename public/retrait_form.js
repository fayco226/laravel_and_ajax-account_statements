function retrait_form(){
    var retrait = `

    <div class="row justify-content-center  ff">
                <fieldset class="col-8 col-md-6 p-3 border rounded" id="natur" data-nature="retrait" >
                ...
                <fieldset class="col-8 col-md-6 p-3 border rounded" >
                    <legend class="legend2">Retrait</legend>
                    <div class="row justify-content-center">
                        <div class="form-group col-sm-9 col-lg-6">
                            <label for="nom">Retiré par</label>
                            <div class="input-group">
            ...
            <p style="background-color: red; color: white; text-align: center; height: 35px;" id="referencef">Afficher la référence</p>
            </div>
            <div class="row justify-content-center zz">
